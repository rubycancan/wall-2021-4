				...
				<div class="papercolor">
					...
					<div class="p-right">
						<div class="color330" id="a1" style="background:#FFDFFF"></div>
	                 	...
	                 	<input type="hidden" value="" name="color" id="idvalue">
					</div>
				</div>
				<div class="papercontent">
					<div class="left">
						...
						<div class="left-bottom">
							<textarea cols="25" rows="8" id="textfont" name="content"></textarea>
						</div>
					</div>
					<div class="right">
						<div class="right-top">
...
<!--							<div style="height:15px"><span>第x条</span><br/></div>-->
						 	<div style="height:100px;margin-top:20px"><span id="font"></span></div>
...
<![endif]-->
	<script type="text/javascript">
		...
		nameright.onchange=function(){
			document.getElementById("name").innerHTML="署名: "+nameright.value;
		}
		...
		$('#myfrom').submit(function() {
            var name = $('#nameright').val(),
                content = $('#textfont').val(),
                codeone = $('#codeone').val(),
                codetwo = $('#codetwo').val();

            //js里null和undifined与空字符串不=;null==undefined,null===undefined是false;在php里NULL和'' ==但是不===，
            if (name == '' || name == null) {
                alert('用户名不能为空！');
                return false;
            }
            ...
            if (codeone == '' || codeone == null || codeone != codetwo) {
                alert('请输入正确的验证码！');
                return false;
            }
            return true;
